  ...
  return (
    <div className="relative flex h-[500px] w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
      ...
      <OrbitingCircles
        ...
        radius={80}
      >
        <a href="https://github.com/AdnanQureshi3" target='_blank'><Icons.gitHub /></a>
      </OrbitingCircles>
      <OrbitingCircles
        className="h-10 w-10 border-none bg-transparent"
        duration={20}
        ...
        radius={80}
      >
        <a href="https://www.codechef.com" target='_blank'><img src={codechef} alt="codechef" /></a>
      </OrbitingCircles>
      ...
      <OrbitingCircles
        ...
        reverse
      >
        <a href="https://leetcode.com/u/Adnan_Qureshi_61/" target='_blank'><img src={leetcode} alt="leetcode" /></a>
      </OrbitingCircles>
      <OrbitingCircles
        className="h-14 w-14 border-none bg-transparent"
        radius={190}
